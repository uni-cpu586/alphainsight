...
- **NO INTERACTIVE/SUDO COMMANDS**: Never run any commands that require interactive user input, sudo passwords, or manual credentials. All commands must be non-interactive.
